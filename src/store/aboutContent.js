const module = {
  state:   {
    aboutMessage:
                '<p>I’m a sound guy currently based in the rainy Cornwall but will be leaving the peninsula and coming back to the South East very soon! (Will miss the pasties though…)</p>' +
